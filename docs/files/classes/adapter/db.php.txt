...
class db
{
    ...
    public function connect($config)
    {
        ...
        if (mysql_select_db($config['dbname'], $this->connect_id)) {
    ...
    public function items($table, $where = '1', $fields = '*', $field = false, $key = false)
    {
    ...
    public function rows($field = false, $key = false)
    {
        $rows = [];
    ...
    public function exists($table, $id, $field = 'id')
    {
